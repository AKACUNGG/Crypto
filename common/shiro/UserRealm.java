package com.cunff.finance.common.shiro;


import com.cunff.finance.entity.Admin;
import com.cunff.finance.entity.AdminPermissions;
import com.cunff.finance.entity.User;
import com.cunff.finance.entity.UserPermissions;
import com.cunff.finance.service.AdminPermissionsService;
import com.cunff.finance.service.AdminService;
import com.cunff.finance.service.UserPermissionsService;
import com.cunff.finance.service.UserService;
...
//        info.addStringPermission("user:add");
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        if (user != null) {
            ...
            System.out.println("创世成功=>核对成功=>"+user.getUsername()+"登录进入系统");
        ...
        if (admin!=null){
            ...
            System.out.println("创世成功=>核对成功=>"+admin.getUsername()+"登录进入系统");
