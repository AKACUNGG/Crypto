...
import com.cunff.finance.entity.TermFinancial;
import com.cunff.finance.entity.UserTermFinancial;
import com.cunff.finance.service.FlowOfFundsService;
import com.cunff.finance.service.TermFinancialService;
import com.cunff.finance.service.UserTermFinancialService;
...
public class TermFinancialController {
    ...
    public String toPaymoney(Model model) {
        ...
        model.addAttribute("pageTopBarInfo", "NFTmint界面");
    ...
    public String toTermFinancialInfo(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
        ...
        model.addAttribute("activeUrl1", "financeActive");
        model.addAttribute("activeUrl2", "termfinancialActive");
        model.addAttribute("pageTopBarInfo", "NFTmint管理界面");
