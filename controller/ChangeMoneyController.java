...
import com.cunff.finance.entity.ChangeMoney;
import com.cunff.finance.entity.FlowOfFunds;
import com.cunff.finance.entity.UserChangeMoney;
import com.cunff.finance.service.ChangeMoneyService;
import com.cunff.finance.service.FlowOfFundsService;
import com.cunff.finance.service.UserChangeMoneyService;
...
public class ChangeMoneyController {
    ...
    public String toChangemoney(Model model){
        ...
        model.addAttribute("pageTopBarInfo","BTC定投界面");
    ...
    public String toUserInfo(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
        ...
        model.addAttribute("activeUrl1", "financeActive");
        model.addAttribute("activeUrl2", "changemoneyActive");
        model.addAttribute("pageTopBarInfo", "BTC定投管理界面");
